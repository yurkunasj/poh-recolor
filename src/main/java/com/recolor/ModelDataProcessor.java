...
public class ModelDataProcessor
{
    ...
    public ModelDataProcessor(String filePath, String type, Color newColor, Color secondaryColor, Boolean harmonize) throws IOException
    {
        this.type = type;
        cacheData(filePath);
    ...
    {
        log.debug("Attempting to applyColor to model... {}", model);
    ...
    public void applyColors(int objectId, String type, Model model, boolean useRecolored)
    {
        ...
        if (colors != null && colors[0] != null && colors[1] != null && colors[2] != null)
        {
            ...
            log.info("{} ID: {}", type, objectId);
            log.info("FaceColors1: {}", model.getFaceColors1());
            log.info("FaceColors2: {}", model.getFaceColors2());
            log.info("FaceColors3: {}", model.getFaceColors3());
        }
    }
